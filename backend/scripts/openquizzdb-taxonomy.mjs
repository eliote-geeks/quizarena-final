...
const IDS = {
  ...
  // Extensions QuizArena : ces rubriques disposent chacune d'un volume
  // suffisant pour dix manches variées sans répéter rapidement un quiz.
  animaux: [10,48,49,50,116,145,173,175,184,237,413],
  environnement: [12,65,126,135,186,199,203,224,263],
  television: [5,21,25,31,36,41,147,189,267,439],
  "jeux-video": [35,204,261],
  automobile: [44,132,157],
  sante: [58,101,118,164,206,393,541],
  arts: [69,86,128,202,405],
  societe: [1,40,58,77,101,111,113,122,129,142,166,168,172,180,205,219,228,277,294,382,543],
  voyages: [14,22,24,30,54,61,66,91,94,100,104,105,107,109,112,117,121,130,156,174,193,208,221,231,240,246,247,251,255],
  "bandes-dessinees": [4,93,114,124,201],
};
