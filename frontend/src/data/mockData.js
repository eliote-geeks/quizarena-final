...
export const CATEGORIES = [
  {
    ...
    icon: Landmark,
    style: "Retro Arcade 8-bit / Antique Gold",
    accent: "#FFD700",
    accent2: "#8B6508",
    glow: "glow-yellow",
    textGlow: "text-glow-yellow",
    bgClass: "from-[#1a1303] via-[#100a01] to-[#05050A]",
    pattern: "scanlines",
    questions: 32,
    description: { fr: "Civilisations, batailles, dates clés", en: "Civilizations, battles, key dates" },
    image: "https://images.unsplash.com/photo-1711319551836-f7ca9764a898?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1NTN8MHwxfHNlYXJjaHwxfHxmYW50YXN5JTIwbGFuZHNjYXBlJTIwbGFuZHNjYXBlfGVufDB8fHx8MTc4MDQzNzg4Nnww&ixlib=rb-4.1.0&q=85",
  },
  {
    id: "geographie",
    name: { fr: "Géographie", en: "Geography" },
    icon: Globe2,
    style: "Holographic / Cybernetic",
    accent: "#00FFFF",
    accent2: "#0055FF",
    glow: "glow-cyan",
    textGlow: "text-glow-cyan",
    bgClass: "from-[#001a1a] via-[#000b14] to-[#05050A]",
    pattern: "grid",
    questions: 28,
    description: { fr: "Capitales, drapeaux, reliefs", en: "Capitals, flags, terrain" },
    image: "https://images.unsplash.com/photo-1672872476232-da16b45c9001?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1NjZ8MHwxfHNlYXJjaHwxfHxuZW9uJTIwY3liZXJwdW5rJTIwY2l0eXxlbnwwfHx8fDE3ODA0Mzc4ODZ8MA&ixlib=rb-4.1.0&q=85",
  },
  {
    id: "sciences",
    name: { fr: "Sciences", en: "Science" },
    icon: FlaskConical,
    style: "Matrix / Biotech Neon",
    accent: "#39FF14",
    accent2: "#003300",
    glow: "glow-green",
    textGlow: "text-glow-green",
    bgClass: "from-[#001a00] via-[#000a05] to-[#05050A]",
    pattern: "matrix",
    questions: 36,
  ...
  },
  {
    ...
    icon: Film,
    style: "Film Noir / Neon Vaporwave",
    accent: "#FF007F",
    accent2: "#4A00E0",
    glow: "glow-pink",
    textGlow: "text-glow-pink",
    bgClass: "from-[#1a0010] via-[#0e0008] to-[#05050A]",
    pattern: "noir",
    questions: 30,
  ...
  },
  {
    ...
    icon: Trophy,
    style: "Arcade Fighting Game",
    accent: "#FF4500",
    accent2: "#FFD700",
    glow: "glow-red",
    textGlow: "text-glow-yellow",
    bgClass: "from-[#1a0a00] via-[#0d0501] to-[#05050A]",
    pattern: "vs",
    questions: 26,
  ...
  },
  {
    ...
    glow: "glow-cyan",
    textGlow: "text-glow-cyan",
    bgClass: "from-[#0c0018] via-[#070010] to-[#05050A]",
    pattern: "synthwave",
    questions: 24,
...
// Sample questions per category for the quiz play page
...
export const USER_PROFILE = {
  ...
  joined: "2025-11-04",
  badges: [
    { id: "b1", name: { fr: "Premier sang", en: "First Blood" }, icon: "swords", color: "#FF3333" },
    { id: "b2", name: { fr: "Cerveau d'acier", en: "Steel Brain" }, icon: "brain", color: "#00FFFF" },
    { id: "b3", name: { fr: "Vitesse lumière", en: "Light Speed" }, icon: "zap", color: "#FFD700" },
    { id: "b4", name: { fr: "Sans faute", en: "Flawless" }, icon: "star", color: "#39FF14" },
    { id: "b5", name: { fr: "Champion", en: "Champion" }, icon: "crown", color: "#FF007F" },
    { id: "b6", name: { fr: "Stratège", en: "Strategist" }, icon: "target", color: "#9D4CDD" },
  ],
  categoryPerf: [
    { id: "histoire", rate: 72 },
